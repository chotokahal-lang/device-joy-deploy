      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center px-6 pt-10 pb-4 relative z-10 gap-5">
        ...
        >
          <h1 className="display-font text-[clamp(2rem,8vw,2.5rem)] leading-[1.05]">
            <LiveText as="span" id="splash-title" defaultText="ᨀᨘᨄᨚᨐᨀᨚ" className="text-gradient" />
          </h1>
        ...
        >
          ...
          <p className="text-[11px] text-muted-foreground leading-relaxed">
            <LiveText as="span" id="splash-desc-1" defaultText="ᨀᨘᨄᨚᨐᨀᨚ" className="font-bold text-foreground" /> — <LiveText as="span" id="splash-desc-2" defaultText="bahasa Makassar." />{" "}
