  ...
  return (
    <div className="flex flex-col min-h-full pb-10">
      ...
      <div className="px-6 flex-1 flex flex-col gap-5">
        ...
        >
          <LiveText as="span" id="daftar-terms" defaultText="Dengan mendaftar, Anda menyetujui ketentuan penggunaan layanan BOYAKO dan menjamin kebenaran data yang dimasukkan. Penyalahgunaan layanan dapat dikenai sanksi sesuai hukum yang berlaku." />
        </motion.p>
      </div>
    </div>
  );
