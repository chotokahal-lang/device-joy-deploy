...
const SLIDE_NARRATIONS: string[] = [
  /* 1 */ "Selamat datang di Aplikasi BOYAKO. Sistem Pencarian dan Arsip Barang Bukti Digital milik Subdit Jatanras, Direktorat Kriminal Umum, Polda Sulawesi Selatan. Dirancang oleh Irzal Makkarawah S.H., Panit Katim ANGGOTA POLRI, tahun 2026.",
  ...
  /* 10 */ "Form Cek Data Mobil untuk Anggota Polri. Masukkan Nomor Polisi atau Nomor Rangka kendaraan. Fitur ini cocok untuk cek cepat saat patroli atau penangkapan di lapangan. Sistem akan mencari dalam database BOYAKO.",
  ...
  /* 13 */ "Form Cek Data Motor untuk Anggota Polri. Input Nomor Polisi atau Nomor Rangka untuk verifikasi status motor dalam database BOYAKO. Contoh yang ditampilkan adalah plat DD 5678 CD.",
  ...
  /* 26 */ "Tampilan Profil Pengguna. Menampilkan informasi lengkap admin yang sedang login: Irzal Makkarawah S.H., NRP 71040012345678, Pangkat Ipda Penyidik, Satker ANGGOTA POLRI, menggunakan BOYAKO versi 2026.1.",
  ...
  /* 28 */ "Halaman Bantuan dan FAQ. Berisi lima pertanyaan umum: penjelasan BOYAKO berasal dari bahasa Makassar Boya yang berarti Cari, siapa yang bisa menggunakan aplikasi, arti jika IMEI tidak ditemukan, langkah jika terdeteksi, dan konfirmasi bahwa data bersifat realtime tersinkronisasi dengan APLIKASI DORS MILIK POLRI",
  /* 29 */ "Halaman penutup. Tentang Aplikasi dan Kredit. BOYAKO versi 2026, Sistem Pencarian dan Arsip Barang Bukti. Dibuat oleh Irzal Makkarawah S.H., Subdit Jatanras Direktorat Kriminal Umum ANGGOTA POLRI. Terintegrasi sistem DORS, rencana integrasi E-MP Bareskrim Polri, berbasis Android, user-friendly, dan real-time. Terima kasih telah menyaksikan presentasi ini.",
];
            ...
            {!soundReady && (
              ...
              >
                ...
                <div className="relative z-10 p-8 flex flex-col items-center max-w-4xl">
                  ...
                  >
                    <LiveText as="span" id="pres-hero-brand" className="text-gradient italic" defaultText="BOYAKO" />
                  </motion.h2>
