  ...
  return (
    <div className="flex flex-col min-h-full pb-10">
      <PageHeader
        ...
        title={<LiveText as="span" id="about-title" defaultText="ᨀᨘᨄᨚᨐᨀᨚ" />}
      ...
      <div className="px-6 space-y-5">
        ...
        >
          ...
          <div>
            <h2 className="display-font text-2xl text-foreground"><LiveText as="span" id="about-brand" defaultText="ᨀᨘᨄᨚᨐᨀᨚ" /></h2>
          ...
          <div className="surface rounded-xl px-4 py-2.5 flex items-start gap-2.5 text-left w-full">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground leading-relaxed mt-0.5">
                ...
                <b className="text-foreground">ᨀᨘᨄᨚᨐᨀᨚ</b> = Saya Carikan Untukmu.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <p className="eyebrow text-muted-foreground/40 text-[9px]">
            <LiveText as="span" id="about-footer" defaultText="ᨀᨘᨄᨚᨐᨀᨚ · RESMOB POLDA SULSEL · 2026 · Hak Cipta Dilindungi" />
          </p>
        </motion.div>
