    ...
    <div className="flex flex-col min-h-full pb-10">
      ...
      <div className="px-6 space-y-5">
        ...
        {(isAdmin || isPolri) && (
          ...
          >
            {[
              ...
              { label: "Versi Aplikasi", value: "BOYAKO v2026.1" },
            ].map((item, i) => (
        ...
        >
          ...
          <p className="text-xs text-muted-foreground flex-1"><LiveText as="span" id="profile-footer-desc" defaultText="BOYAKO · RESMOB POLDA SULSEL · 2026" /></p>
