...
const FAQS = [
  {
    q: "Apa itu BOYAKO?",
    a: "BOYAKO adalah sistem arsip digital barang bukti kendaraan & HP dari RESMOB POLDA SULSEL. Nama berasal dari bahasa Makassar — \"Boya\" berarti Cari.",
  },
  {
  ...
  return (
    <div className="flex flex-col min-h-full pb-10">
      <PageHeader
        ...
        subtitle={<LiveText as="span" id="faq-subtitle" defaultText="Pertanyaan yang sering diajukan tentang BOYAKO." />}
        back="/profile"
        right={
