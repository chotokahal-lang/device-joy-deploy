      ...
      <div className="px-6 space-y-6 relative z-10">
        ...
        >
          ...
          <p className="text-xs text-muted-foreground leading-relaxed">
            <LiveText id="priv-1-desc" defaultText="BOYAKO (Aplikasi RESMOB POLDA SULSEL) berkomitmen penuh untuk melindungi setiap data yang diinput ke dalam sistem. Data barang bukti, identitas pelapor, dan log aktivitas admin dikelola dengan standar keamanan enkripsi militer." />
          </p>
        </motion.div>
