...
export const ALL_NOTIFS: Notification[] = [
  ...
  { id: 8, type: "info", title: "📱 Pembaruan Sistem BOYAKO", desc: "v2026.1 · LP Search & Arsip Digital diperbarui", time: "Kemarin", roles: ["admin"], timestamp: Date.now() - 1000 * 60 * 60 * 24 },
  ...
  { id: 14, type: "info", title: "📱 Pembaruan Sistem BOYAKO", desc: "v2026.1 · Fitur cek LP & detail BB diperbarui", time: "Kemarin", roles: ["polri"], timestamp: Date.now() - 1000 * 60 * 60 * 18 },
  ...
  { id: 17, type: "info", title: "⏰ Layanan BOYAKO Aktif 24 Jam", desc: "Cek kendaraan & HP kapan saja · RESMOB POLDA SULSEL", time: "Kemarin", roles: ["umum"], timestamp: Date.now() - 1000 * 60 * 60 * 22 },
  ...
  { id: 19, type: "info", title: "📱 Pembaruan Layanan", desc: "BOYAKO v2026.1 · Verifikasi wajah & identitas lebih aman", time: "2 hari lalu", roles: ["umum"], timestamp: Date.now() - 1000 * 60 * 60 * 48 },
];
  ...
  return (
    <div className="flex flex-col min-h-full pb-10">
      <PageHeader
        ...
        subtitle={<LiveText as="span" id="notif-subtitle" defaultText="Pembaruan dan peringatan sistem BOYAKO." />}
        back={true}
        right={
